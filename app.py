...
class mainApp(QtWidgets.QMainWindow):
    ...
    def cargarConfigs2(self):
        ...
        carga el archivo especificado desde la carpeta ~/Documentos/LKE/tools/Tensorflow/research/object_detection/samples/configs/
        :return:
        """
        try:
...
#------------------------------------    TESTING parte 2   ----------------------------------------
    ...
    def _abrirImagen(self):
        ...
        # /LKE_framework/tools/TensorFlow/research/object_detection/object_detection_test.py --image_dir=/home/gustavo/Documentos/LKE_framework/data/classification/image4.jpg
        :return:
        """
        dirconfigs, _ = QFileDialog.getOpenFileName(
            self,
